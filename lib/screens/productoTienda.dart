...
class ProductoMascotaScreen extends StatefulWidget {
  final int idtienda;
  const ProductoMascotaScreen({super.key, required this.idtienda});

  @override
  State<ProductoMascotaScreen> createState() => _ProductoMascotaScreenState();
}

class _ProductoMascotaScreenState extends State<ProductoMascotaScreen> {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                      onPressed: () {
                          mostrarConfirmacionRegistro(context, registrarProducto); // 👈 Muestra el mensaje en lugar de registrar directo
                        },
