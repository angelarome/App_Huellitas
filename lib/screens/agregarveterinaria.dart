...
class _AgregarVeterinariaScreenState extends State<AgregarVeterinariaScreen> {
  ...
  Future<void> registrarVeterinaria() async {
    ...
    if (departamentoSeleccionado == null || departamentoSeleccionado!.isEmpty) camposFaltantes.add("Departamento");
    if (ciudadSeleccionada == null || ciudadSeleccionada!.isEmpty) camposFaltantes.add("Ciudad");
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        // Opcional: resetear selecciones de horas y dropdowns
        setState(() {
          _horaApertura = null;
          _horaCierre = null;
