...
import 'dart:ui';
import 'inicial4.dart';
import 'pantalla_inicio.dart';

class ComidapaseoMascotasScreen extends StatelessWidget {
  const ComidapaseoMascotasScreen({super.key});
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        "Registra su comida, agua y paseos",
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Text(
                              "Lleva un control diario de sus comidas, agua, paseos y hábitos.",
                        ...
                        child: OutlinedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const AlarmaMascotasScreen(), 
                              ),
                            );
                          },
