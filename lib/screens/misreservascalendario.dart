...
class CalendarioReservasScreen extends StatefulWidget {
  ...
  const CalendarioReservasScreen({super.key, required this.id_dueno});
...
void mostrarConfirmacion(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      extendBodyBehindAppBar: true, // <-- AppBar encima del fond
      body: Stack(
        children: [
          // ------------ FONDO ------------
          Container(
                                ...
                                children: [
                                  ...
                                  ElevatedButton.icon(
                                    onPressed: () {
                                      mostrarConfirmacion(
                                      context,
                                      mensaje: "¿Confirmas que ya recogiste tu reserva?",
