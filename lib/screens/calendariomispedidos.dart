...
class CalendarioTiendaScreen extends StatefulWidget {
  ...
  const CalendarioTiendaScreen({super.key, required this.id_dueno});
...
class _CalendarioTiendaScreenState extends State<CalendarioTiendaScreen> {
  ...
  Future<void> _obtenerpedidos() async {
    final url = Uri.parse("https://apphuellitas-production.up.railway.app/mispedidos");
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        _todosLosPedidos = pedido.map<Map<String, dynamic>>((m) => Map<String, dynamic>.from(m)).toList(); 
      });
    }
  }
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: pedidosAgrupados.entries.map((entry) {
                      ...
                      final tienda = primerItem["nombre_negocio"];
                                ...
                                children: [
                                  ...
                                  ElevatedButton.icon(
                                    onPressed: () {
                                      mostrarConfirmacion(
                                      context,
                                      mensaje: "¿Estás seguro de que no recibiste este producto?",
                                  ...
                                  ElevatedButton.icon(
                                    onPressed: () {
                                      mostrarConfirmacion(
                                      context,
                                      mensaje: "¿Estás seguro de haber recibido este pedido?",
